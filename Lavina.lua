...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or LaViNaTAEM}}}
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@LaViNaTAEM]'))
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@LaViNaTAEM]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source Lavina     --
--        Contact         --
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/LaViNaTAEM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source Lavina     --
...
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/LaViNaTAEM' end
